...
export const metadata: Metadata = {
  ...
  description: "Browse the version-locked DS_B.0.4.19 Dungeon Settlers database; v0.4.23 is the current official update boundary.",
...
export default function DatabasePage() {
  return (
    <div className="page-shell database-page">
      ...
      <p className="eyebrow">Version-locked data / DS_B.0.4.19 · current official boundary v0.4.23</p>
      <h1>Dungeon Settlers database reference</h1>
      <p className="lead">Browse the DS_B.0.4.19 Dungeon Settlers database snapshot behind the Research, Clay, settlement and expedition questions. The current official numbered boundary is v0.4.23, so this searchable reference remains version-locked and must not be read as a current-build table until it is re-extracted.</p>
      ...
      <div className="database-source-card">
        <div><p className="eyebrow">Evidence boundary</p><h2>Stock game file extraction, dated {gameDataSnapshot.extracted}</h2><p>DungeonSettlers.wiki identifies this as a byte-exact parse of the unmodded game files for Steam build {gameDataSnapshot.steamBuildId}. It is a reviewed secondary source locked to DS_B.0.4.19. Official Steam pages remain the authority for the game identity and patch notes, including v0.4.23; use the source links to audit the snapshot and recheck it after updates.</p><div className="database-source-links"><a href={gameDataSnapshot.source.page} rel="noreferrer">Source home ↗</a><a href={gameDataSnapshot.source.manifest} rel="noreferrer">Source manifest ↗</a><a href={gameDataSnapshot.source.dataGuide} rel="noreferrer">Data schema notes ↗</a><a href="https://steamcommunity.com/app/2798330/allnews/" rel="noreferrer">Official update path ↗</a></div></div>
