      ...
      <body>
        ...
        <footer>
          <div className="footer-inner">
            ...
            <div className="footer-links"><a href="/tools/first-expedition-planner">First expedition planner</a><a href="/library">Guide library</a><a href="https://store.steampowered.com/app/2798330/Dungeon_Settlers/" rel="noreferrer">Official Steam page</a><a href="https://www.youtube.com/watch?v=BkGIa5V39-w" rel="noreferrer">Official trailer</a><a href="/updates">Guide updates</a></div>
          </div>
