...
- 事实边界：S001 为官方玩法和产品身份；S011 为当前官方 v0.4.23 编号边界；S012 为公告级 Archer 平衡回退；S013 为无玩法影响的活动公告；S003 为二手 Clay 观察；S004/S005 仅作为已尝试但不可分析的视频参考，不提供前台事实。
- 事实边界：S008 仍是 DS_B.0.4.19 的 31 条 Research、62 条资源、244 条物品、111 条单位、559 条建筑、244 条掉落、163 条配方和 8 条商人池旧快照；它没有被伪装成 v0.4.23。未来版本、实机冲突和 universal best order 仍需重验。
