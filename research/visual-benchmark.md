...
- `artifacts/quality/migration-complete/44e606c2-80cc-40ea-a1c7-1ba8eb2c26dc/` 保存本轮四条旅程的桌面/移动关键状态截图；`artifacts/production/migration-journey.json` 记录同一 runId、8 个 viewport、3 条旧路径、内链、横向溢出和脚本错误结果。
