...
- `artifacts/quality/migration-final/f4911a8d-ca10-4200-bc12-dbf9c1c64ca5/` 保存本轮四条旅程的桌面/移动关键状态截图；`artifacts/production/migration-journey.json` 记录同一 runId、8 个 viewport、3 条旧路径、内链、横向溢出和脚本错误结果。
