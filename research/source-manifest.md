...
- 官方 Steam/YouTube 页面可用于事实回查与官方入口链接；本地页面不热链、不复制第三方截图或视频帧。
- 首页主视觉采用本站原创 SVG 编辑插画，依据 S001 的 settlement/dungeon/research 主题重绘，不复制官方角色、Logo、UI 或截图；机制图采用本站原创 SVG。
