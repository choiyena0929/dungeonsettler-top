...
- URL：<https://steamcommunity.com/games/2798330/announcements/detail/1842846814451295>
- 观察：2026-09-09；官方公告说明 Early Access 前三天已连续发布三次更新，并列出 v0.4.12、v0.4.17、v0.4.19 的已发布路径。
- 支持事实：官方正在根据反馈准备后续改进，包括高难度锁定选项、视野、休息频率和战斗寻路等方向；这些是计划中的工作，不是已发布版本或本站可直接承诺的机制。
- 不支持的结论：公告没有公布高于 v0.4.19 的编号版本，也没有新增 Clay 路线、数量或固定 Research 前置。
- 可公开使用：是；用于说明版本边界和待复查方向，不把未来计划写成当前功能。
