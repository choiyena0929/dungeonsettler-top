...
- 当前分支：`main`
- 上游分支：`origin/main`
- 当前 HEAD：`48cfe49`；每次开工仍必须实时读取；当前工作树与 `origin/main` 已核对。

## 首版范围

- Dungeon Settlers beginner guide
- How to get clay in Dungeon Settlers
- How to research in Dungeon Settlers
