    ...
    assets: [
      {
        ...
        gameSpecific: true,
        originalOrGenerated: false,
        state: "in-use",
        required: true,
        source: { class: "official-cdn", pageUrl: "https://example.com/media", assetUrl: "https://cdn.example.com/hero.webp", evidence: "research/source-manifest.md#M001" },
      ...
      },
      {
        ...
        state: "in-use",
        required: true,
        source: { class: "official-game-files", pageUrl: "https://example.com/media", assetUrl: "game-files://icons/", evidence: "research/source-manifest.md#M002" },
        rights: { status: "confirmed", basis: "fixture approval" },
